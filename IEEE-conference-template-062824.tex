%=============================================================
%  IEEE Conference / Journal style paper Three-Stage CMOS Ring Oscillator in 65
%  nm: Design, Physical Verification, and Post-Layout Simulation
%
%  NOTE ON COMPILING:
%   * For IEEE submission / Overleaf: keep \documentclass below as
%       \documentclass[conference]{IEEEtran} (IEEEtran.cls is preinstalled on
%       Overleaf and IEEE systems.)
%   * Placeholders that you must fill in are marked with  <<< ... >>> and with
%     the \TODO{} macro so they are easy to find.
%=============================================================
...
\begin{figure}[t]
\centering
\includegraphics[width=0.45\columnwidth]{flow.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\columnwidth]{layout.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\columnwidth]{layout_sim.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\columnwidth]{pnoise.png}
...
\bibitem{razavi_book}
B.~Razavi, \emph{Design of Analog CMOS Integrated Circuits}. New York, NY, USA:
McGraw-Hill, 2001.
 
\bibitem{razavi_rf}
B.~Razavi, \emph{RF Microelectronics}, 2nd~ed. Upper Saddle River, NJ, USA:
Prentice Hall, 2012.
 
\bibitem{lee_book}
T.~H. Lee, \emph{The Design of CMOS Radio-Frequency Integrated Circuits},
2nd~ed. Cambridge, U.K.: Cambridge Univ. Press, 2004.
 
%--- Delay cell / ring oscillator foundations ---
\bibitem{maneatis1996}
J.~G. Maneatis, ``Low-jitter process-independent DLL and PLL based on
self-biased techniques,'' \emph{IEEE J. Solid-State Circuits}, vol.~31, no.~11,
pp.~1723--1732, Nov. 1996.
 
\bibitem{maneatis1993}
J.~G. Maneatis and M.~A. Horowitz, ``Precise delay generation using coupled
oscillators,'' \emph{IEEE J. Solid-State Circuits}, vol.~28, no.~12,
pp.~1273--1282, Dec. 1993.
 
%--- Phase noise theory ---
\bibitem{hajimiri1998}
A.~Hajimiri and T.~H. Lee, ``A general theory of phase noise in electrical
oscillators,'' \emph{IEEE J. Solid-State Circuits}, vol.~33, no.~2,
pp.~179--194, Feb. 1998.
 
\bibitem{hajimiri1999}
A.~Hajimiri, S.~Limotyrakis, and T.~H. Lee, ``Jitter and phase noise in ring
oscillators,'' \emph{IEEE J. Solid-State Circuits}, vol.~34, no.~6,
pp.~790--804, Jun. 1999.
 
\bibitem{lee2000}
T.~H. Lee and A.~Hajimiri, ``Oscillator phase noise: A tutorial,'' \emph{IEEE J.
...
%--- Ring oscillator / VCO designs (prior art) ---
...
%--- Recent works: VERIFY details before submitting ---
\bibitem{ro_45nm_2024}
\TODO{verify} ``Uncovering the power of ring oscillators: A comparative analysis
in 45-nm CMOS technology,'' \emph{J. Chemical Health Risks}, vol.~14, no.~1,
2024.
 
\bibitem{ildcro2023}
\TODO{verify} ``A high FoM and low phase noise edge-injection-based ring
oscillator in 350~nm CMOS for sub-GHz ADPLL applications,'' \emph{Electronics},
vol.~12, no.~18, Art. no.~3769, 2023.
 
\bibitem{ringvco_5g_2024}
\TODO{verify} ``A current-starved negative-skewed-delay ring-based VCO for 5G
applications in 65~nm CMOS,'' \emph{Emerging Science Journal}, vol.~8, no.~1,
2024.
